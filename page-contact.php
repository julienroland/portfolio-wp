						...
						<fieldset>
							...
							<div class="row">
								<div class="large-6 columns">
									...
									<input type="text"  name="email" id="email" placeholder="vous@gmail.com" value="<?php if(isset($_POST['email']))  echo $_POST['email'];?>" class="requiredField email" />
									<?php if($emailError != '') { ?>
...
// User Loop
             ...
             <address itemscope itemtype="http://schema.org/Person">
             	<span class="name contact" itemprop="name"><i class="icon-user"></i>&nbsp;<a href=""><?php echo $user->display_name ; ?></a></span>
             	<meta itemprop="name" content="http://www.julien-roland.be"/>
             	<span class="mail contact" itemprop="email"><i class="icon-envelope-alt"></i>&nbsp;<?php echo $user->user_email ; ?></span>
